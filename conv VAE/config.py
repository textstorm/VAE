...
def get_args():
  ...
  parser.add_argument('--log_dir', type=str, default='/root/textstorm/VAE/conv VAE/logs/')
  parser.add_argument('--save_dir', type=str, default='/root/textstorm/VAE/conv VAE/saves/')
  parser.add_argument('--nb_classes', type=int, default=10, help='nb_classes')
